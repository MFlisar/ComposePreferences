...
import com.michaelflisar.composepreferences.demo.DateTimeUtil
...
private fun PreferenceScope.PreferenceThatNeedsDataStore(
    dataStore: DemoDataStore?,
    content: @Composable PreferenceScope.(dataStore: DemoDataStore) -> Unit
) {
    if (dataStore == null) {
...
@Composable
expect fun PreferenceScope.PreferenceAppSelector(dataStore: DemoDataStore)
