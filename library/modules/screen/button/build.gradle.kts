...
val description = "provides a button preference screen"

// Module
val artifactId = "screen-button"
val androidNamespace = "com.michaelflisar.composepreferences.screen.button"
