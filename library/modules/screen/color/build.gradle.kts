...
val description = "provides a color picker preference screen"

// Module
val artifactId = "screen-color"
val androidNamespace = "com.michaelflisar.composepreferences.screen.color"
