...
val description = "provides a number picker preference screen"

// Module
val artifactId = "screen-number"
val androidNamespace = "com.michaelflisar.composepreferences.screen.number"
